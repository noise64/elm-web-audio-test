...
Elm.WebAudio.AudioProcessor = Elm.WebAudio.AudioProcessor || {};
Elm.WebAudio.AudioProcessor.make = function (_elm) {
   "use strict";
   _elm.WebAudio = _elm.WebAudio || {};
   _elm.WebAudio.AudioProcessor = _elm.WebAudio.AudioProcessor || {};
   if (_elm.WebAudio.AudioProcessor.values) return _elm.WebAudio.AudioProcessor.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Native$WebAudio$AudioProcessor = Elm.Native.WebAudio.AudioProcessor.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var StereoAudioProcessor = F2(function (a,b) {    return {commandAddress: a,stateSignal: b};});
   var Playing = function (a) {    return {ctor: "Playing",_0: a};};
   var StoppedAt = function (a) {    return {ctor: "StoppedAt",_0: a};};
   var Stop = {ctor: "Stop"};
   var stereoAudioProcessor = function (processAudio) {
      var stateMailbox = $Signal.mailbox(StoppedAt(0));
      var sendStatePlaying = function (timeInSamples) {    return A2($Signal.send,stateMailbox.address,Playing(timeInSamples));};
      var sendStateStoppedAt = function (timeInSamples) {    return A2($Signal.send,stateMailbox.address,StoppedAt(timeInSamples));};
      var commandMailbox = $Signal.mailbox(Stop);
      var _p0 = A4($Native$WebAudio$AudioProcessor.stereoAudioProcessor,processAudio,commandMailbox.signal,sendStatePlaying,sendStateStoppedAt);
      return {commandAddress: commandMailbox.address,stateSignal: stateMailbox.signal};
   };
   var Continue = {ctor: "Continue"};
   var PlayFrom = function (a) {    return {ctor: "PlayFrom",_0: a};};
   var PlayFromStart = {ctor: "PlayFromStart"};
   return _elm.WebAudio.AudioProcessor.values = {_op: _op
                                                ,stereoAudioProcessor: stereoAudioProcessor
                                                ,StereoAudioProcessor: StereoAudioProcessor
...
Elm.Main.make = function (_elm) {
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $WebAudio$AudioProcessor = Elm.WebAudio.AudioProcessor.make(_elm);
   var _op = {};
   var processAudio = function () {
      var ampModRight2 = function (t) {    return $Basics.cos(t / 441000.0 * 1.7) + 1.0;};
      var ampModRight1 = function (t) {    return $Basics.sin(t / 441000.0 * 2.2) + 1.0;};
      var ampModLeft2 = function (t) {    return $Basics.cos(t / 441000.0 * 2.0) + 1.0;};
      var ampModLeft1 = function (t) {    return $Basics.sin(t / 441000.0 * 1.0) + 1.0;};
      var fmModRight = function (t) {    return 1 - $Basics.cos(t / (5000 + $Basics.sin(t / 400) * 50)) * 1.0e-2;};
      var fmModLeft = function (t) {    return 1 - $Basics.sin(t / (10000 + $Basics.sin(t / 3000) * 500)) * 1.0e-2;};
      var freqModRight = function (t) {    return $Basics.sin((t + 20000.0) / 441000.0) * 5;};
      var freqModLeft = function (t) {    return $Basics.sin(t / 441000.0) * 10;};
      var sine = function (_p0) {    var _p1 = _p0;return $Basics.sin(_p1._0 / _p1._1) * _p1._2;};
      var sumSine = function (tps) {    return $List.sum(A2($List.map,sine,tps));};
      var leftMono = function (t) {
         return sumSine(_U.list([{ctor: "_Tuple3",_0: t,_1: 18.0 + freqModLeft(t),_2: ampModLeft1(t)}
                                ,{ctor: "_Tuple3",_0: t,_1: 12.0 * fmModLeft(t),_2: 1.0}
                                ,{ctor: "_Tuple3",_0: t,_1: 40.1 + freqModLeft(t),_2: ampModLeft1(t)}
                                ,{ctor: "_Tuple3",_0: t,_1: 12.0,_2: ampModLeft2(t)}
                                ,{ctor: "_Tuple3",_0: t,_1: 48.0,_2: 1}]));
      };
      var rightMono = function (t) {
         return sumSine(_U.list([{ctor: "_Tuple3",_0: t,_1: 18.0,_2: ampModRight1(t)}
                                ,{ctor: "_Tuple3",_0: t,_1: 15.0 + freqModRight(t),_2: 1.0}
                                ,{ctor: "_Tuple3",_0: t,_1: 40.0 + freqModRight(t),_2: 1.0}
                                ,{ctor: "_Tuple3",_0: t,_1: 12.1 * fmModRight(t),_2: ampModRight2(t)}
                                ,{ctor: "_Tuple3",_0: t,_1: 62.0,_2: 1.0}]));
      };
      var leftPoly = function (t) {    return leftMono(t) * 0.5 + rightMono(t - 441000.0 * 0.2) * 0.21 + leftMono(t - 441000.0 * 0.15) * 0.3;};
      var rightPoly = function (t) {    return rightMono(t) * 0.5 + leftMono(t - 441000.0 * 0.3) * 0.2 + rightMono(t - 441000.0 * 0.2) * 0.3;};
      return function (t) {
         return {ctor: "_Tuple2",_0: leftPoly(t),_1: rightPoly(t)};
      };
   }();
   var main = function () {
      var guiSpacer = A2($Graphics$Element.spacer,10,10);
      var audioProcessor = $WebAudio$AudioProcessor.stereoAudioProcessor(processAudio);
      var renderGui = function (state) {
         return A2($Graphics$Element.flow,
         $Graphics$Element.right,
         _U.list([A2($Graphics$Input.button,A2($Signal.message,audioProcessor.commandAddress,$WebAudio$AudioProcessor.PlayFromStart),"Play")
                 ,guiSpacer
                 ,A2($Graphics$Input.button,A2($Signal.message,audioProcessor.commandAddress,$WebAudio$AudioProcessor.Continue),"Continue")
                 ,guiSpacer
                 ,A2($Graphics$Input.button,A2($Signal.message,audioProcessor.commandAddress,$WebAudio$AudioProcessor.Stop),"Stop")
                 ,guiSpacer
                 ,$Graphics$Element.show(A2($Debug.log,"state",state))]));
      };
      return A2($Signal.map,renderGui,audioProcessor.stateSignal);
   }();
   return _elm.Main.values = {_op: _op,processAudio: processAudio,main: main};
};
